...
def pcusage():
        ...
        billing = open("billing.csv","w")
        bw = csv.writer(billing)
        tophead = ["NAME","EMAILID","PC USED","LOGIN TIME","DATE","STARTING TIME","ENDING TIME","MINUTES USED","CHARGE/HOUR","PRINTING CHARGE","TOTAL:(in Rs.)"]
        bw.writerow(tophead)
